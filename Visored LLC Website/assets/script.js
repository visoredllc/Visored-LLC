...
Object.assign(translations.Spanish, {
  ...
  "Clear": "Limpiar",
  "After you submit, Visored reviews your details and typically responds within 1 business day. Placeholder form only until connected to email or a form service.": "Despues de enviar, Visored revisa sus detalles y normalmente responde dentro de 1 dia habil. Formulario temporal hasta conectarlo a email o un servicio de formularios.",
  ...
  "Quick answers about demos, packages, monthly operations, alterations, and what happens after you reach out.": "Respuestas rapidas sobre demos, paquetes, operaciones mensuales, alteraciones y que pasa despues de contactarnos.",
  ...
  "Can I upgrade my package later?": "Puedo mejorar mi paquete despues?",
  ...
  "The $49.99 monthly plan helps cover ongoing essentials such as hosting support, form checks, basic upkeep, and general site availability for eligible website packages.": "El plan mensual de $49.99 ayuda a cubrir esenciales continuos como soporte de hosting, revision de formularios, mantenimiento basico y disponibilidad general.",
  "Payment is discussed before full website development begins. Flexible financing options may be available depending on the package, project needs, and agreed timeline.": "El pago se conversa antes de iniciar el desarrollo completo. Puede haber opciones de financiamiento segun el paquete, necesidades y tiempo acordado.",
  "Yes. Flexible financing options are available and can be discussed based on the package and project needs.": "Si. Hay opciones de financiamiento flexibles que se pueden conversar segun el paquete y las necesidades.",
  ...
  "Yes. Add-ons such as contact forms, appointment scheduling, newsletter forms, sign-up pages, custom features, and multi-language options can be added at any time.": "Si. Add-ons como formularios, citas, boletines, paginas de registro, funciones personalizadas y opciones multilingues se pueden agregar en cualquier momento.",
  ...
  "Use the placeholder form below to plan the information you want to collect from future prospects.": "Use el formulario temporal para planificar la informacion que desea recibir de futuros prospectos.",
  ...
  ,"Thanks. This placeholder form is ready to connect to your real email or form service.": "Gracias. Este formulario temporal esta listo para conectarse a su email real o servicio de formularios."
  ,"Thanks. This placeholder design form is ready to connect to your real submission workflow.": "Gracias. Este formulario temporal de diseno esta listo para conectarse a su flujo real de envio."
  ...
  ,"You can send content, photos, and update requests by email or by contacting Visored directly by phone.": "Puede enviar contenido, fotos y solicitudes de actualizacion por email o contactando directamente a Visored por telefono."
...
document.querySelectorAll(".feature-card, .price-card, .review-card, .next-step-grid article, .add-on-grid article, .process-detail-grid article, .faq-item, .estimate-output, .estimate-controls fieldset").forEach((card) => {
...
const revealTargets = document.querySelectorAll(
  "main > section, .feature-card, .price-card, .review-card, .next-step-grid article, .timeline-diagram article, .add-on-grid article, .process-detail-grid article, .faq-item, .contact-card, fieldset"
);
...
const updateDiscoveryBackground = () => {
  ...
  if (!discoveryHome || window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
    return;
  }
...
const requestDiscoveryBackground = () => {
  if (!discoveryHome || discoveryBgFrame) {
    return;
  }
